ALTER TABLE case_step ADD COLUMN IF NOT EXISTS optional INTEGER NOT NULL DEFAULT 0;
ALTER TABLE case_attachment ADD COLUMN IF NOT EXISTS step_id INTEGER NULL REFERENCES case_step(id) ON DELETE SET NULL;
